...
{% include picts-left.html
  ...
  description="The matrix for the right example uses &quot;extened arrows&quot;. The example on the right does not have this trick, but it is harder to see where the stitches are in the tread diagram."
%}
