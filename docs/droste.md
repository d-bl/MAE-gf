...
The picture on the right shows the general scheme. The stitches of the Paris ground are replaced with "blocks". In the picture, one block is indicated with a blue ellipse. The buttons below replaces this block with the block shown on the button. Please note that the block to the right is the mirrored version of the first block.
<p style="clear: both"></p>
