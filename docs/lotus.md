...
Please note: if a lotus has an odd number of horizontal, like H3, the weavers changes direction at the next set of lotus. This is not shown in the matrices used for the examples.
