...
In the ground shown on the picture the threads between the bottom and top position of two units are <span class="stch">crossed</span> four times. Please note that there are no twists between the <span class="stch">cross only</span> and <span class="stch">whole stitch</span> at the pins. For more ants, see page [_Rose grounds_][pag-ants].       

<p style="clear: both"></p>

The [star][T-3cc] looks like a three paired join, but has crossings instead of twists. For the real star see page [_Miscellaneous_][pag-3-join]. 
