...
A bobbin lace stitch is defined as something that happens when four bobbins meet on a pillow. On this page, we present an (incomplete) list of stitches to choose from. There are more than 1000 possibilities.     
On page [_listing and counting stitches_](counting), we will show a logical ordering of the stitches and the way we counted them.     
...
The samples and photos are made by S. Babbs. Clicking on the photo shows a larger image.       
